...
CREATE TABLE IF NOT EXISTS AI_Requirement_Parse_Task (
    ...
    created_by INT NULL COMMENT '创建人ID，关联 Auto_Users.id',
...
CREATE TABLE IF NOT EXISTS AI_Requirement_Attachment (
    ...
    created_by INT NULL COMMENT '上传人ID，关联 Auto_Users.id',
...
CREATE TABLE IF NOT EXISTS AI_Requirement_Question (
    ...
    answered_by INT NULL COMMENT '回答人ID，关联 Auto_Users.id',
...
CREATE TABLE IF NOT EXISTS AI_Requirement_Risk (
    ...
    resolved_by INT NULL COMMENT '处理人ID，关联 Auto_Users.id',
