...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    label: "AI 工作台",
    children: [
      { label: "工作台总览", href: "/ai-workbench/overview", icon: <LayoutDashboard className="h-4 w-4" /> },
      { label: "需求输入与解析", href: "/ai-workbench/requirement-input", icon: <FileText className="h-4 w-4" /> },
      { label: "需求分析与测试点", href: "/ai-workbench/requirement-analysis", icon: <ListChecks className="h-4 w-4" /> },
      { label: "用例生成与编辑", href: "/ai-workbench/case-generation", icon: <Wand2 className="h-4 w-4" /> },
